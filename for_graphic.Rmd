...
div_palette <- c("#2E74C0", "#ACCE55", "#617", "#01D135", "#4D0835", "#FAB",
                 "#F81", "#F3D024", "#9DF")

ggplot(all, aes(x = n_courses, y = enrollment, size = avg_class_size, 
                alpha = 0.5, color = division)) +
  geom_point() +
  ...
  # scale_color_manual(values = div_palette) + 
  guides(alpha = FALSE,
         size = guide_legend(title = "Mean Class Size"),
         color = guide_legend(title = " Academic Division")) +
