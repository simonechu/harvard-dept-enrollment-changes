...
all <- bind_rows(f16, s17, f17, s18, f18, s19) %>%
  ...
  mutate(division = case_when(
    ...
    # course_department == "Special Concentrations" ~ "Special Concentrations",
    
    course_department == "Expository Writing" ~ "Expository Writing"
    
    # course_department == "Freshman Seminars" ~ "Freshman Seminars",
    # 
    # course_department == "General Education" ~ "General Education", 
    # 
    # course_department == "House Seminars" ~ "House Seminars"
  ))
...
ggplot(all, aes(x = n_courses, y = enrollment, size = avg_class_size, 
  ...
  labs(title = "Department Size, Fall 2016 - Spring 2019",
       subtitle = "Term Beginning: {closest_state}") + 
